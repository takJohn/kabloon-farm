/// --- Particle System (Modified from MANA-Burning-Altar scene) ---
...
// NOTE: only modified a few values so that the particles look
// like they're coming from the balloon's burners
